...
class Tx_ProjectsAndTasks_Utility_AjaxDispatcher {
    ...
    public function dispatch() {
        ...
        $configuration['extensionName'] = 'projectsandtasks';
...
//        $request->setControllerExtensionName('Projects');
//        $request->setPluginName('pi1');
//        //$request->setControllerName($controller);
//        $request->setControllerActionName('ajaxResponse');
//        $uid[uid] = 11;
//        $request->setArguments($uid);
        return $request;
    }
	...
	public function initCallArguments() {
        ...
        //Übergabe der POST Parameter @edit Klaus
        $extension  = $_POST["request"]["extensionName"];
        $plugin     = $_POST["request"]["pluginName"];
        $controller = $_POST["request"]["controllerName"];
        $action     = $_POST["request"]["actionName"];
        $argu       = $_POST["request"]["arguments"];
        ...
        $this->arguments = $argu;
        // end edit Klaus
        //Tx_Extbase_Utility_Debugger::var_dump($argu);
